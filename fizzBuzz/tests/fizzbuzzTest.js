...
(function() {
      ...
      it("should return fizz since its indivisible by 3 ", function() {
      ...
      it("should return undefind since it is not a number", function() {
        expect(myApp.fizzBuzz("scsdad")).toBe(undefined);
      });
